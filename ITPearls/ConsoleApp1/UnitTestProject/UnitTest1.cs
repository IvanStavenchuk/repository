...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            var list = new List<IPAddress>() { IPAddress.Parse("192.168.1.17"), IPAddress.Parse("192.168.1.30") };
        ...
        {
            var list = new List<IPAddress>() { IPAddress.Parse("192.168.1.17"), IPAddress.Parse("192.168.1.33") };
